                ...
                <div className="col-xs-12">
                  <div className="col">
                    <div className="hero-illustration-sec">
                      <img src="../images/2-Minutes-Illustration-hero.png" className="hero-illustration" alt="" />
                    </div>
                  </div>
                </div>
                <div className="col-xs-12">
        ...
        <div className="row">
          <div className="col-xs-12 walkthrough-sec-2">
            <div className="illustration-2-sec col-xs-6">
              <div className="col">
                <img src="../images/2-Minutes-Illustration-002.png" className="illustration-2" alt="" />
              </div>
            </div>
            <div className="product-learning-2 col-xs-6">
              <div className="col">
                ...
                <p>
                  Answer your questions on daily basis and review them.
                  If you want to change your questions/goals,
                  you can change them anytime as per your wish.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="col-xs-12 walkthrough-sec-3">
            <div className="product-learning-3 col-xs-6">
              <div className="col">
                ...
                <p>
                We provide you with deep easy,understandable data statistics about
                your progress and performance.
                This helps you keep track of your progress and addressing your weakness,
            ...
            <div className="illustration-3-sec col-xs-6">
              <div className="col">
                <img src="../images/2-Minutes-Illustration-003.png" className="illustration-3" alt="" />
              </div>
            </div>
          </div>
        </div>
